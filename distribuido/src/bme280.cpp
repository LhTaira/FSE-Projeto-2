...
void get_bme() {
  ...
  temperatura = ((float)teInt) / 100.0;
//   pressure = pressureInt / 100;
  umidade = ((float) humidityInt / 1000.0);
}
...
int bme280ReadValues(int *T, int *P, int *H) {
  ...
  var2 =
      (((((t >> 4) - (calT1)) * ((t >> 4) - (calT1))) >> 12) * (calT3)) >> 14;
  t_fine = var1 + var2;
  *T = (t_fine * 5 + 128) >> 8;
  ...
  var1_64 = ((var1_64 * var1_64 * (int64_t)calP3) >> 8) +
            ((var1_64 * (int64_t)calP2) << 12);
  ...
  var1 = (t_fine - 76800);
  var1 =
      (((((h << 14) - ((calH4) << 20) - ((calH5)*var1)) + (16384)) >> 15) *
       (((((((var1 * (calH6)) >> 10) * (((var1 * (calH3)) >> 11) + (32768))) >>
           10) +
          (2097152)) *
             (calH2) +
         8192) >>
